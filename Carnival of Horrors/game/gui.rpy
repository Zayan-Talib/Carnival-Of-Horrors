...
define gui.hover_color = '#80d6f3'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#90e733'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#88888871'
...
define gui.text_color = '#f9f5bbc0'
define gui.interface_text_color = '#f5ce80'
...
## bottom order.
define gui.namebox_borders = Borders(5, 5, 60, 11)
